...
/* ================================================================== */
struct ini_info *
ini_load(const char *filename, unsigned *error, unsigned *error_line)
{
  char              buf[512], *s;
  struct ini_info  *ret;
...
const char *
ini_next_parameter(struct ini_info *ii, const char **parameter)
{
...
char *
ini_get(struct ini_info *ii, const char *section, const char *parameter)
{
  struct section   *curr_sect;
  struct parameter *curr_param;
...
static void ini_dump(struct ini_info *ii) {
  const char *section, *parameter, *value;
